    ...
    public function searchingRoom():ResponseInterface{
        ...
        foreach ($list_room as $room) {
            ...
            if(empty($last_contract)){
                ...
                $card_text .= '<div class="d-flex justify-content-between mt-1"> <span class="badge rounded-pill bg-label-success">đang thuê</span> <strong> ngày hết hạn '  . date("d/m/y",$last_contract->time_expire) .   '</strong></div>';
